...
async def _fetchone(query: str, params: tuple = ()) -> Optional[dict]:
    """Возвращает dict (поддерживает .get()) вместо sqlite3.Row."""
    async with aiosqlite.connect(DB_PATH) as db:
...
async def _fetchall(query: str, params: tuple = ()) -> list[dict]:
    """Возвращает list[dict] (поддерживает .get()) вместо list[sqlite3.Row]."""
    async with aiosqlite.connect(DB_PATH) as db:
        db.row_factory = aiosqlite.Row
        async with db.execute(query, params) as cur:
...
class UserRepo:
    ...
    @staticmethod
    async def get_all_with_access() -> list[dict]:
    ...
    @staticmethod
    async def resolve(identifier: str) -> Optional[dict]:
        """
...
class WorkbookRepo:
    ...
    @staticmethod
    async def get_by_serial(serial_number: int) -> Optional[dict]:
    ...
    @staticmethod
    async def delete(serial_number: int) -> Optional[dict]:
...
class CuratorRepo:
    ...
    @staticmethod
    async def get_by_tid(telegram_id: int) -> Optional[dict]:
        return await _fetchone("SELECT * FROM curators WHERE telegram_id=?", (telegram_id,))

    @staticmethod
    async def get_by_id(curator_id: int) -> Optional[dict]:
...
class GroupRepo:
    ...
    @staticmethod
    async def get_by_curator(curator_id: int) -> list[dict]:
...
class StudentRepo:
    ...
    @staticmethod
    async def get_by_id(student_id: int) -> Optional[dict]:
        return await _fetchone("SELECT * FROM students WHERE id=?", (student_id,))

    @staticmethod
    async def get_by_group(group_id: int) -> list[dict]:
...
class SubmissionRepo:
    ...
    @staticmethod
    async def get_all(limit: int = 200) -> list[dict]:
        return await _fetchall(
    ...
    @staticmethod
    async def get_by_curator(curator_id: int, limit: int = 200) -> list[dict]:
        return await _fetchall(
    ...
    @staticmethod
    async def get_today(curator_id: Optional[int] = None) -> list[dict]:
    ...
    @staticmethod
    async def get_by_id(submission_id: int) -> Optional[dict]:
    ...
    @staticmethod
    async def get_by_student_id(student_id: int, limit: int = 30) -> list[dict]:
...
class PhotoBufferRepo:
    ...
    @staticmethod
    async def get_by_student(student_id: int) -> list[dict]:
        return await _fetchall(
...
class ExamSlotRepo:
    ...
    @staticmethod
    async def get_free_by_curator(curator_id: int) -> list[dict]:
    ...
    @staticmethod
    async def get_free_by_curator_and_date(curator_id: int, slot_date: str) -> list[dict]:
    ...
    @staticmethod
    async def get_by_id(slot_id: int) -> Optional[dict]:
    ...
    @staticmethod
    async def get_upcoming_unnotified() -> list[dict]:
...
class ExamBookingRepo:
    ...
    @staticmethod
    async def get_active_by_student(student_id: int) -> Optional[dict]:
        return await _fetchone(
    ...
    @staticmethod
    async def get_all_for_export() -> list[dict]:
        return await _fetchall(
...
class PracticeRepo:
    ...
    @staticmethod
    async def get_by_id(practice_id: int) -> Optional[dict]:
